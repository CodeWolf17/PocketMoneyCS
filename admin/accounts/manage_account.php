        ...
        <div class="container-fluid">
            <form id="account-form">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control col-sm-6"  name="account_number" value="<?php echo isset($account_number)? $account_number : '' ?>" required>
                </div>
                <hr>
                <div class="row">
                ...
                <?php if(!isset($id)): ?>
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control " name="pin" id="confirmed_pin" maxlength="4" value="<?php echo isset($pin)? $pin : '' ?>"  <?php echo (!isset($id)) ? "required" : '' ?> >
